...
export const useDialogStore = defineStore('dialog', () => {
    ...
    // On and off switch for dialouge option list
    ...
    // On and off switch for event dialogue option response
    const optionResponseDialog = ref<boolean>(false)
    ...
    const toggleDialog = (type: string) => {
        switch(type){
            ...
            break;
            case 'dialogue-option-list':
                optionListDialog.value = !optionListDialog.value
            break;
            ...
            case 'option-response':
                optionResponseDialog.value = !optionResponseDialog.value
            break;
            case 'context-menu':
